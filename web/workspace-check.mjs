...
const configurationHTML=run('productConfiguration()');
assert.ok(configurationHTML.includes('data-config-tab=\"workspace\"'));
run(`configurationTab='workspace'`);
