...
type Release struct {
	...
	RecordedExternally   bool              `json:"recorded_externally,omitempty"`
...
type State struct {
	...
	RuntimeSnapshots       []RuntimeSnapshot      `json:"runtime_snapshots"`
